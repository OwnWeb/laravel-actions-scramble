...
/**
 * Retrieves documentation for Laravel Action validation rules.
 * 
 * @internal
 */
class LaravelActionsRulesDocumentationRetriever implements RulesDocumentationRetriever
{
    ...
    {
        if ($item->key instanceof LiteralStringType) {
